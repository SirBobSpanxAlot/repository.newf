...
class halibutStubs:
    ...
    def create_stubs():
        ...
        return {
            "xbmc": {
                "getInfoLabel": halibutStubs.xbmc.getInfoLabel,
                "translatePath": halibutStubs.xbmc.translatePath,
                "log": halibutStubs.xbmc.log,
                "getSupportedMedia": halibutStubs.xbmc.getSupportedMedia,
                "getLanguage": halibutStubs.xbmc.getLanguage,
                "getLocalizedString": halibutStubs.xbmc.getLocalizedString,
                "getCondVisibility": halibutStubs.xbmc.getCondVisibility,
                "executebuiltin": halibutStubs.xbmc.executebuiltin,
                "PlayList": halibutStubs.xbmc.PlayList,
                "Monitor": halibutStubs.xbmc.Monitor,
                "validatePath": lambda t: t,
                "sleep": lambda t: time.sleep(t / 1000),
                "executeJSONRPC": halibutStubs.xbmc.executeJSONRPC,
            },
            "xbmcaddon": {"Addon": halibutStubs.xbmcaddon.Addon},
            "xbmcgui": {
                "ListItem": halibutStubs.xbmcgui.ListItem,
                "Window": halibutStubs.xbmcgui.Window,
                "Dialog": halibutStubs.xbmcgui.Dialog,
                "DialogBusy": halibutStubs.xbmcgui.DialogBusy,
                "DialogProgress": halibutStubs.xbmcgui.DialogProgress,
                "DialogProgressBG": halibutStubs.xbmcgui.DialogProgressBG,
            },
            "xbmcplugin": {
                "addDirectoryItem": halibutStubs.xbmcplugin.addDirectoryItem,
                "addDirectoryItems": halibutStubs.xbmcplugin.addDirectoryItems,
                "endOfDirectory": halibutStubs.xbmcplugin.endOfDirectory,
                "addSortMethod": halibutStubs.xbmcplugin.addSortMethod,
                "setContent": halibutStubs.xbmcplugin.setContent,
            },
            "xbmcvfs": {
                "File": halibutStubs.File,
        ...
        def translatePath(path):
            ...
            if name == "xbmc":
                ...
                if not MOCK.RUN_AGAINST_INSTALLATION and all(
                        x in parts for x in ["addons", "plugin.video.halibut"]
                ):
    ...
    class xbmcaddon:
        class Addon(xbmcaddon.Addon):
            ...
            def _load_addon_config(self):
                ...
                try:
                    filepath = os.path.join(MOCK.halibut_ROOT, "addon.xml")
...
class MonkeyPatchKodiStub:
    ...
    def __init__(self):
        self._dict = halibutStubs.create_stubs()
...
class MockKodi:
    ...
    def __init__(self):
        ...
        self.halibut_ROOT = self.PROFILE_ROOT
        ...
        self.INTERACTIVE_MODE = (
                os.environ.get("halibut_INTERACTIVE_MODE", False) == "True"
        )
        self.RUN_AGAINST_INSTALLATION = (
                os.environ.get("halibut_RUN_AGAINST_INSTALLATION", False) == "True"
        )
        if self.RUN_AGAINST_INSTALLATION and os.path.exists(
            ...
            self.halibut_ROOT = os.path.join(
                self.PROFILE_ROOT, "addons", "plugin.video.halibut"
            )
