...
def dispatch(params):
    ...
    overwrite_cache = params.get("halibut_reload") == "true"
    ...
    g.log("halibut, Running Path - {}".format(g.REQUEST_PARAMS))
    ...
    if action == "genericEndpoint":
        ...
        try:
            ...
            halibut_player = player.halibutPlayer()
            halibut_player.play_source(
