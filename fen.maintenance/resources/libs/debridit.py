...
DEBRIDID = {
    ...
    'fenad': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'temp-fanart.png'),
        ...
        'activate' : 'RunPlugin(plugin.video.fen/?action=openSettings)'},
    'fenrd': {
        'name'     : 'fen RD',
        'plugin'   : 'plugin.video.fen',
        'saved'    : 'fenrd',
    ...
    'fenpm-oauth': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'fen_pmoauth'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fen', 'settings.xml'),
