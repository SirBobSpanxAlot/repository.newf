...
ORDER = ['easynews-fen',
         ...
         'fanart-scrubs', 'fanart-fen', 'fanart-thecrew', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         ...
         'tmdb-scrubs', 'tmdb-fen', 'tmdb-thecrew', 'tmdb-tmdbhelper',
         'tmdb-venom',
         'trakt-openmeta', 'trakt-fen',
         'tvdb-metahandler', 'tvdb-openmeta', 'tvdb-premiumizer',
         'tvdb-realizer', 'tvdb-fen',
...
LOGINID = {
    ...
    'tmdb-fen': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'fanart-fox-gold-final.png'),
    ...
    'trakt-fen': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'fen_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fen', 'settings.xml'),
    ...
    'tvdb-fen': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'fen_tvdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fen', 'settings.xml'),
        'default'  : 'tvdb.apikey',
    ...
    'fanart-fen': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.fen', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'fen_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.fen', 'settings.xml'),
