...
ORDER = ['easynews-fen',
         ...
         'fanart-scrubs', 'fanart-newf', 'fanart-thecrew', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         ...
         'tmdb-scrubs', 'tmdb-newf', 'tmdb-thecrew', 'tmdb-tmdbhelper',
         'tmdb-venom',
         'trakt-openmeta', 'trakt-newf',
         'tvdb-metahandler', 'tvdb-openmeta', 'tvdb-premiumizer',
         'tvdb-realizer', 'tvdb-newf',
...
LOGINID = {
    ...
    'tmdb-newf': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.newf', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.newf', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'newf_tmdb'),
    ...
    'trakt-newf': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.newf', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.newf', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'newf_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.newf', 'settings.xml'),
    ...
    'tvdb-newf': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.newf', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.newf', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'newf_tvdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.newf', 'settings.xml'),
        'default'  : 'tvdb.apikey',
    ...
    'fanart-newf': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.newf', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.newf', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'newf_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.newf', 'settings.xml'),
