...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Newf[/B][/COLOR][COLOR {color2}]Cleaner[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Newf Cleaner.\n\nContact us on Github at http://www.github.com/newf276/plugin.program.cleaner/'
...
REPOADDONXML = 'https://raw.githubusercontent.com/newf276/repository.newf/master/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://raw.githubusercontent.com/newf276/repository.newf/master/zips/repository.openwizard/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR deepskyblue][B]Newf[/B][/COLOR]Cleaner'
