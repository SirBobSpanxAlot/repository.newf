...
class TraktAPI:
    def __init__(self):
        ...
        if self.ClientID == '':
            self.ClientID = '52cbe0868c5d7caa1d0f85a50ec333d655a9f469719b67df5d3cba6ce73d478f'

        self.ClientSecret = ''
        self.ClientSecret = tools.getSetting('trakt.secret')
        if self.ClientSecret == '':
            self.ClientSecret = 'd5575e7683a48b3e2968d6c21d19da3ba807b7a04f7ed0e803c5dfc465a1e134'
