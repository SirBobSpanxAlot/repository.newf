...
ORDER = ['fenad', 'fenpm', 'fenrd',
         ...
         'pmzer',
         'sockeyead', 'sockeyepm', 'sockeyepm-oauth', 'sockeyerd', 
...
DEBRIDID = {
    ...
    'sockeyead': {
        'name'     : 'sockeye AD',
        'plugin'   : 'plugin.video.sockeye',
        'saved'    : 'sockeyead',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'sockeye_ad'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.sockeye', 'settings.xml'),
        'default'  : 'alldebrid.username',
        'data'     : ['alldebrid.enabled', 'alldebrid.username', 'alldebrid.token'],
        'activate' : 'RunPlugin(plugin.video.sockeye/?action=openSettings)'},
    'sockeyerd': {
        'name'     : 'sockeye RD',
        'plugin'   : 'plugin.video.sockeye',
        'saved'    : 'sockeyerd',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'sockeye_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.sockeye', 'settings.xml'),
        'default'  : 'rd.username',
        'data'     : [ 'rd.auth', 'rd.client_id', 'rd.expiry', 'rd.refresh', 'rd.secret', 'rd.username', 'realdebrid.enabled'],
        'activate' : 'RunPlugin(plugin://plugin.video.sockeye/?action=authRealDebrid)'},
    'sockeyepm': {
        'name'     : 'sockeye PM (API Key)',
        'plugin'   : 'plugin.video.sockeye',
        'saved'    : 'sockeyepm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'sockeye_pm'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.sockeye', 'settings.xml'),
        'default'  : 'premiumize.pin',
        'data'     : ['premiumize.enabled', 'premiumize.pin'],
        'activate' : 'RunPlugin(plugin.video.sockeye/?action=openSettings)'},
    'sockeyepm-oauth': {
        'name'     : 'sockeye PM (OAuth)',
        'plugin'   : 'plugin.video.sockeye',
        'saved'    : 'sockeyepm-oauth',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'sockeye_pmoauth'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.sockeye', 'settings.xml'),
