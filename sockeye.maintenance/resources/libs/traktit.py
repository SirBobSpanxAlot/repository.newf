...
ORDER = ['exodusredux', 'fen', 'gaia', 'numbers', 'openmeta', 'premiumizer',
         'realizer', 'scrubs', 'sockeye', 'shadow', 'thecrew', 'trakt', 'venom']
...
TRAKTID = {
    ...
    'sockeye': {
        ...
        'file'     : os.path.join(CONFIG.TRAKTFOLD, 'sockeye_trakt'),
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.sockeye/?action=authTrakt)'},
    'trakt': {
        'name'     : 'Trakt',
        'plugin'   : 'script.trakt',
        'saved'    : 'trakt',
