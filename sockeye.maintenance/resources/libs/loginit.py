...
ORDER = ['easynews-fen',
         ...
         'fanart-scrubs', 'fanart-sockeye', 'fanart-thecrew', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         ...
         'tmdb-scrubs', 'tmdb-sockeye', 'tmdb-thecrew', 'tmdb-tmdbhelper',
         'tmdb-venom',
         'trakt-openmeta', 'trakt-sockeye',
         'tvdb-metahandler', 'tvdb-openmeta', 'tvdb-premiumizer',
         'tvdb-realizer', 'tvdb-sockeye',
...
LOGINID = {
    ...
    'tmdb-sockeye': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'sockeye_tmdb'),
    ...
    'trakt-sockeye': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'sockeye_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.sockeye', 'settings.xml'),
    ...
    'tvdb-sockeye': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'sockeye_tvdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.sockeye', 'settings.xml'),
        'default'  : 'tvdb.apikey',
        'data'     : ['tvdb.apikey', 'tvdb.jw', 'tvdb.expiry'],
        'activate' : ''},
    'fanart-sockeye': {
        'name'     : 'Fanart.tv - sockeye',
        'plugin'   : 'plugin.video.sockeye',
        'saved'    : 'fanart-sockeye',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.sockeye', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'sockeye_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.sockeye', 'settings.xml'),
