...
properties = [
    "context.chinook.quickResume",
    "context.chinook.shuffle",
    "context.chinook.playFromRandomPoint",
    "context.chinook.rescrape",
    "context.chinook.sourceSelect",
    "context.chinook.findSimilar",
    "context.chinook.browseShow",
    "context.chinook.browseSeason",
    "context.chinook.traktManager",
]
...
xbmc.log("context.chinook service: starting", xbmc.LOGINFO)
...
try:
    ...
    xbmc.log("context.chinook service: error - {}".format(e), xbmc.LOGERROR)
finally:
    del properties_monitor

xbmc.log("context.chinook service: stopped", xbmc.LOGINFO)
