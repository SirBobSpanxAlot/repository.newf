...
ORDER = ['easynews-fen',
         ...
         'fanart-scrubs', 'fanart-chinook', 'fanart-thecrew', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         ...
         'tmdb-scrubs', 'tmdb-chinook', 'tmdb-thecrew', 'tmdb-tmdbhelper',
         'tmdb-venom',
         'trakt-openmeta', 'trakt-chinook',
         'tvdb-metahandler', 'tvdb-openmeta', 'tvdb-premiumizer',
         'tvdb-realizer', 'tvdb-chinook',
...
LOGINID = {
    ...
    'tmdb-chinook': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'chinook_tmdb'),
    ...
    'trakt-chinook': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'chinook_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.chinook', 'settings.xml'),
    ...
    'tvdb-chinook': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'chinook_tvdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.chinook', 'settings.xml'),
        'default'  : 'tvdb.apikey',
        'data'     : ['tvdb.apikey', 'tvdb.jw', 'tvdb.expiry'],
        'activate' : ''},
    'fanart-chinook': {
        'name'     : 'Fanart.tv - chinook',
        'plugin'   : 'plugin.video.chinook',
        'saved'    : 'fanart-chinook',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'chinook_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.chinook', 'settings.xml'),
