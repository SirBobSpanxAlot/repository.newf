...
ORDER = ['exodusredux', 'fen', 'gaia', 'numbers', 'openmeta', 'premiumizer',
         'realizer', 'scrubs', 'coho', 'shadow', 'thecrew', 'trakt', 'venom']
...
TRAKTID = {
    ...
    'coho': {
        ...
        'file'     : os.path.join(CONFIG.TRAKTFOLD, 'coho_trakt'),
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.coho/?action=authTrakt)'},
    'trakt': {
        'name'     : 'Trakt',
        'plugin'   : 'script.trakt',
        'saved'    : 'trakt',
