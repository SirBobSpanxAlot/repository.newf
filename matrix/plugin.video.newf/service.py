...
from resources.lib.modules.newfMonitor import newfMonitor
from resources.lib.modules.update_news import do_update_news

g.init_globals(sys.argv)
g.set_setting("general.tempSilent", "false")
g.HOME_WINDOW.setProperty("newfDownloadManagerIndex", "{}")
...
try:
    xbmc.executebuiltin(
        'RunPlugin("plugin://plugin.video.newf/?action=longLifeServiceManager")'
    )
