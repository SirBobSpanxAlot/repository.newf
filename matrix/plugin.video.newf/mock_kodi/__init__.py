...
class newfStubs:
    ...
    def create_stubs():
        ...
        return {
            "xbmc": {
                "getInfoLabel": newfStubs.xbmc.getInfoLabel,
                "translatePath": newfStubs.xbmc.translatePath,
                "log": newfStubs.xbmc.log,
                "getSupportedMedia": newfStubs.xbmc.getSupportedMedia,
                "getLanguage": newfStubs.xbmc.getLanguage,
                "getCondVisibility": newfStubs.xbmc.getCondVisibility,
                "executebuiltin": newfStubs.xbmc.executebuiltin,
                "PlayList": newfStubs.xbmc.PlayList,
                "Monitor": newfStubs.xbmc.Monitor,
                "validatePath": lambda t: t,
                "sleep": lambda t: time.sleep(t / 1000),
            },
            "xbmcaddon": {"Addon": newfStubs.xbmcaddon.Addon},
            "xbmcgui": {
                "ListItem": newfStubs.xbmcgui.ListItem,
                "Window": newfStubs.xbmcgui.Window,
                "Dialog": newfStubs.xbmcgui.Dialog,
                "DialogBusy": newfStubs.xbmcgui.DialogBusy,
                "DialogProgress": newfStubs.xbmcgui.DialogProgress,
                "DialogProgressBG": newfStubs.xbmcgui.DialogProgressBG,
            },
            "xbmcplugin": {
                "addDirectoryItem": newfStubs.xbmcplugin.addDirectoryItem,
                "addDirectoryItems": newfStubs.xbmcplugin.addDirectoryItems,
                "endOfDirectory": newfStubs.xbmcplugin.endOfDirectory,
                "addSortMethod": newfStubs.xbmcplugin.addSortMethod,
                "setContent": newfStubs.xbmcplugin.setContent,
            },
            "xbmcvfs": {
                "File": newfStubs.xbmcvfs.open,
        ...
        def translatePath(path):
            ...
            if name == "xbmc":
                ...
                if not MOCK.RUN_AGAINST_INSTALLATION and all(
                        x in parts for x in ["addons", "plugin.video.newf"]
                ):
    ...
    class xbmcaddon:
        class Addon(xbmcaddon.Addon):
            ...
            def _load_addon_config(self):
                ...
                try:
                    filepath = os.path.join(MOCK.newf_ROOT, "addon.xml")
...
class MonkeyPatchKodiStub:
    ...
    def __init__(self):
        self._dict = newfStubs.create_stubs()
...
class MockKodi:
    ...
    def __init__(self):
        ...
        self.newf_ROOT = self.PROFILE_ROOT
        self.KODI_UI_LANGUAGE = os.environ.get("KODI_UI_LANGUAGE", "en-gb")
        self.INTERACTIVE_MODE = (
                os.environ.get("newf_INTERACTIVE_MODE", False) == "True"
        )
        self.RUN_AGAINST_INSTALLATION = (
                os.environ.get("newf_RUN_AGAINST_INSTALLATION", False) == "True"
        )
        if self.RUN_AGAINST_INSTALLATION and os.path.exists(
            ...
            self.newf_ROOT = os.path.join(
                self.PROFILE_ROOT, "addons", "plugin.video.newf"
            )
