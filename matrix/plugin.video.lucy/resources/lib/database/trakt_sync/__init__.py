...
class TraktSyncDatabase(Database):
    ...
    def set_base_activities(self):
        self.execute_sql(
            "INSERT OR REPLACE INTO activities(sync_id, lucy_version, trakt_username) VALUES(1, ?, ?)",
    ...
    def _check_database_version(self):
        ...
        if tools.compare_version_numbers(
            self.activities["lucy_version"], self.last_meta_update
        ):
