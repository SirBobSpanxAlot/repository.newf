...
class lucyStubs:
    ...
    def create_stubs():
        ...
        return {
            "xbmc": {
                "getInfoLabel": lucyStubs.xbmc.getInfoLabel,
                "translatePath": lucyStubs.xbmc.translatePath,
                "log": lucyStubs.xbmc.log,
                "getSupportedMedia": lucyStubs.xbmc.getSupportedMedia,
                "getLanguage": lucyStubs.xbmc.getLanguage,
                "getCondVisibility": lucyStubs.xbmc.getCondVisibility,
                "executebuiltin": lucyStubs.xbmc.executebuiltin,
                "PlayList": lucyStubs.xbmc.PlayList,
                "Monitor": lucyStubs.xbmc.Monitor,
                "validatePath": lambda t: t,
                "sleep": lambda t: time.sleep(t / 1000),
            },
            "xbmcaddon": {"Addon": lucyStubs.xbmcaddon.Addon},
            "xbmcgui": {
                "ListItem": lucyStubs.xbmcgui.ListItem,
                "Window": lucyStubs.xbmcgui.Window,
                "Dialog": lucyStubs.xbmcgui.Dialog,
                "DialogBusy": lucyStubs.xbmcgui.DialogBusy,
                "DialogProgress": lucyStubs.xbmcgui.DialogProgress,
                "DialogProgressBG": lucyStubs.xbmcgui.DialogProgressBG,
            },
            "xbmcplugin": {
                "addDirectoryItem": lucyStubs.xbmcplugin.addDirectoryItem,
                "addDirectoryItems": lucyStubs.xbmcplugin.addDirectoryItems,
                "endOfDirectory": lucyStubs.xbmcplugin.endOfDirectory,
                "addSortMethod": lucyStubs.xbmcplugin.addSortMethod,
                "setContent": lucyStubs.xbmcplugin.setContent,
            },
            "xbmcvfs": {
                "File": lucyStubs.xbmcvfs.open,
        ...
        def translatePath(path):
            ...
            if name == "xbmc":
                ...
                if not MOCK.RUN_AGAINST_INSTALLATION and all(
                        x in parts for x in ["addons", "plugin.video.lucy"]
                ):
    ...
    class xbmcaddon:
        class Addon(xbmcaddon.Addon):
            ...
            def _load_addon_config(self):
                ...
                try:
                    filepath = os.path.join(MOCK.lucy_ROOT, "addon.xml")
...
class MonkeyPatchKodiStub:
    ...
    def __init__(self):
        self._dict = lucyStubs.create_stubs()
...
class MockKodi:
    ...
    def __init__(self):
        ...
        self.lucy_ROOT = self.PROFILE_ROOT
        self.KODI_UI_LANGUAGE = os.environ.get("KODI_UI_LANGUAGE", "en-gb")
        self.INTERACTIVE_MODE = (
                os.environ.get("lucy_INTERACTIVE_MODE", False) == "True"
        )
        self.RUN_AGAINST_INSTALLATION = (
                os.environ.get("lucy_RUN_AGAINST_INSTALLATION", False) == "True"
        )
        if self.RUN_AGAINST_INSTALLATION and os.path.exists(
            ...
            self.lucy_ROOT = os.path.join(
                self.PROFILE_ROOT, "addons", "plugin.video.lucy"
            )
