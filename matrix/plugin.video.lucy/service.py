...
from resources.lib.modules.lucyMonitor import lucyMonitor
from resources.lib.modules.update_news import do_update_news

g.init_globals(sys.argv)
g.set_setting("general.tempSilent", "false")
g.HOME_WINDOW.setProperty("lucyDownloadManagerIndex", "{}")
...
try:
    xbmc.executebuiltin(
        'RunPlugin("plugin://plugin.video.lucy/?action=longLifeServiceManager")'
    )
