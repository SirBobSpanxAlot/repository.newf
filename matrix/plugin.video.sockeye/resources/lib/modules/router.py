...
def dispatch(params):
    ...
    overwrite_cache = params.get("sockeye_reload") == "true"
    ...
    g.log("sockeye, Running Path - {}".format(g.REQUEST_PARAMS))
    ...
    if action == "genericEndpoint":
        ...
        try:
            ...
            sockeye_player = player.sockeyePlayer()
            sockeye_player.play_source(
