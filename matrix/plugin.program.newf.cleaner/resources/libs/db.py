...
#                           yeslabel="[B][COLOR deepskyblue]Enable[/COLOR][/B]",
...
#                             yeslabel="[B][COLOR deepskyblue]View List[/COLOR][/B]",
...
#                         yeslabel="[B][COLOR deepskyblue]Hide Passwords[/COLOR][/B]",
...
#                         yeslabel="[B][COLOR deepskyblue]Unhide Passwords[/COLOR][/B]",
#                         nolabel="[B][COLOR red]No Cancel[/COLOR][/B]"):
#         count = 0
#         for folder in glob.glob(os.path.join(CONFIG.ADDONS, '*/')):
#             sett = os.path.join(folder, 'resources', 'settings.xml')
