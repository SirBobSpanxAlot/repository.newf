...
ORDER = ['fenad', 'fenpm', 'fenrd',
         ...
         'pmzer',
         'Newfad', 'Newfpm', 'Newfpm-oauth', 'Newfrd', 
...
DEBRIDID = {
    ...
    'Newfad': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'Newf_ad'),
        ...
        'activate' : 'RunPlugin(plugin.video.Newf/?action=openSettings)'},
    'Newfrd': {
        'name'     : 'Newf RD',
        'plugin'   : 'plugin.video.Newf',
        'saved'    : 'Newfrd',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'Newf_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.Newf', 'settings.xml'),
        'default'  : 'rd.username',
        'data'     : [ 'rd.auth', 'rd.client_id', 'rd.expiry', 'rd.refresh', 'rd.secret', 'rd.username', 'realdebrid.enabled'],
        'activate' : 'RunPlugin(plugin://plugin.video.Newf/?action=authRealDebrid)'},
    'Newfpm': {
        'name'     : 'Newf PM (API Key)',
        'plugin'   : 'plugin.video.Newf',
        'saved'    : 'Newfpm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'Newf_pm'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.Newf', 'settings.xml'),
    ...
    'Newfpm-oauth': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.Newf', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'Newf_pmoauth'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.Newf', 'settings.xml'),
