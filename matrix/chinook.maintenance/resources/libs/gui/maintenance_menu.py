...
class MaintenanceMenu:
    ...
    def clean_menu(self):
        ...
        directory.add_file(
            'Total Clean Up: [COLOR deepskyblue][B]{0}[/B][/COLOR]'.format(tools.convert_size(totalsize)), {'mode': 'fullclean'},
            icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        directory.add_file('Clear Cache: [COLOR deepskyblue][B]{0}[/B][/COLOR]'.format(tools.convert_size(sizecache)),
        ...
        directory.add_file('Clear Packages: [COLOR deepskyblue][B]{0}[/B][/COLOR]'.format(tools.convert_size(sizepack)),
                           {'mode': 'clearpackages'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        directory.add_file(
            'Clear Thumbnails: [COLOR deepskyblue][B]{0}[/B][/COLOR]'.format(tools.convert_size(sizethumb)),
            {'mode': 'clearthumb'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        if os.path.exists(CONFIG.ARCHIVE_CACHE):
            directory.add_file('Clear Archive_Cache: [COLOR deepskyblue][B]{0}[/B][/COLOR]'.format(
        ...
        if autoclean == 'true':
            directory.add_file(
                '--- Auto Clean Frequency: [B][COLOR deepskyblue]{0}[/COLOR][/B]'.format(
        ...
        if includeall == 'true':
            ...
            includechinook = 'true' if CONFIG.INCLUDEchinook == 'true' else 'false'
        ...
        if includevid == 'true':
            ...
            if xbmc.getCondVisibility('System.HasAddon(plugin.video.chinook)'):
                directory.add_file(
                    '--- Include chinook: {0}'.format(includechinook.replace('true', on).replace('false', off)),
                    {'mode': 'togglecache', 'name': 'includechinook'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
    ...
    def logging_menu(self):
        ...
        directory.add_file('View Errors in Log: [COLOR deepskyblue][B]{0}[/B][/COLOR]'.format(errorsfound), {'mode': 'viewerrorlog'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
        if errors > 0:
        ...
        directory.add_file('Clear Wizard Log File: [COLOR deepskyblue][B]{0}[/B][/COLOR]'.format(wizlogsize), {'mode': 'clearwizlog'}, icon=CONFIG.ICONMAINT, themeit=CONFIG.THEME3)
