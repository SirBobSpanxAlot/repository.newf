...
ORDER = ['exodusredux', 'fen', 'gaia', 'numbers', 'openmeta', 'premiumizer',
         'realizer', 'scrubs', 'chinook', 'shadow', 'thecrew', 'trakt', 'venom']
...
TRAKTID = {
    ...
    'chinook': {
        ...
        'file'     : os.path.join(CONFIG.TRAKTFOLD, 'chinook_trakt'),
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.chinook/?action=authTrakt)'},
    'trakt': {
        'name'     : 'Trakt',
        'plugin'   : 'script.trakt',
        'saved'    : 'trakt',
