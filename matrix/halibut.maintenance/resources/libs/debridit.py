...
ORDER = ['fenad', 'fenpm', 'fenrd',
         ...
         'pmzer',
         'halibutad', 'halibutpm', 'halibutpm-oauth', 'halibutrd', 
...
DEBRIDID = {
    ...
    'halibutad': {
        'name'     : 'halibut AD',
        'plugin'   : 'plugin.video.halibut',
        'saved'    : 'halibutad',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'halibut_ad'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.halibut', 'settings.xml'),
        'default'  : 'alldebrid.username',
        'data'     : ['alldebrid.enabled', 'alldebrid.username', 'alldebrid.token'],
        'activate' : 'RunPlugin(plugin.video.halibut/?action=openSettings)'},
    'halibutrd': {
        'name'     : 'halibut RD',
        'plugin'   : 'plugin.video.halibut',
        'saved'    : 'halibutrd',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'halibut_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.halibut', 'settings.xml'),
        'default'  : 'rd.username',
        'data'     : [ 'rd.auth', 'rd.client_id', 'rd.expiry', 'rd.refresh', 'rd.secret', 'rd.username', 'realdebrid.enabled'],
        'activate' : 'RunPlugin(plugin://plugin.video.halibut/?action=authRealDebrid)'},
    'halibutpm': {
        'name'     : 'halibut PM (API Key)',
        'plugin'   : 'plugin.video.halibut',
        'saved'    : 'halibutpm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'halibut_pm'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.halibut', 'settings.xml'),
        'default'  : 'premiumize.pin',
        'data'     : ['premiumize.enabled', 'premiumize.pin'],
        'activate' : 'RunPlugin(plugin.video.halibut/?action=openSettings)'},
    'halibutpm-oauth': {
        'name'     : 'halibut PM (OAuth)',
        'plugin'   : 'plugin.video.halibut',
        'saved'    : 'halibutpm-oauth',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'halibut_pmoauth'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.halibut', 'settings.xml'),
