...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Lucy[/B][/COLOR][COLOR {color2}]Cleaner[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing OpenWizard.\n\nContact us on Github at http://www.github.com/newf276/plugin.program.lucy.cleaner/'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR deepskyblue][B]Lucy[/B][/COLOR]Cleaner'
