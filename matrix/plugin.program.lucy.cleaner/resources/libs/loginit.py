...
ORDER = ['easynews-fen',
         ...
         'fanart-scrubs', 'fanart-lucy', 'fanart-thecrew', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         ...
         'tmdb-scrubs', 'tmdb-lucy', 'tmdb-thecrew', 'tmdb-tmdbhelper',
         'tmdb-venom',
         'trakt-openmeta', 'trakt-lucy',
         'tvdb-metahandler', 'tvdb-openmeta', 'tvdb-premiumizer',
         'tvdb-realizer', 'tvdb-lucy',
...
LOGINID = {
    ...
    'tmdb-lucy': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'lucy_tmdb'),
    ...
    'trakt-lucy': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'lucy_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.lucy', 'settings.xml'),
    ...
    'tvdb-lucy': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'lucy_tvdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.lucy', 'settings.xml'),
        'default'  : 'tvdb.apikey',
    ...
    'fanart-lucy': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'lucy_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.lucy', 'settings.xml'),
