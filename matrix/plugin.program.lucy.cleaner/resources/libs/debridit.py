...
ORDER = ['fenad', 'fenpm', 'fenrd',
         ...
         'pmzer',
         'lucyad', 'lucypm', 'lucypm-oauth', 'lucyrd', 
...
DEBRIDID = {
    ...
    'lucyad': {
        ...
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'lucy_ad'),
        ...
        'activate' : 'RunPlugin(plugin.video.lucy/?action=openSettings)'},
    'lucyrd': {
        'name'     : 'lucy RD',
        'plugin'   : 'plugin.video.lucy',
        'saved'    : 'lucyrd',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'lucy_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.lucy', 'settings.xml'),
        'default'  : 'rd.username',
        'data'     : [ 'rd.auth', 'rd.client_id', 'rd.expiry', 'rd.refresh', 'rd.secret', 'rd.username', 'realdebrid.enabled'],
        'activate' : 'RunPlugin(plugin://plugin.video.lucy/?action=authRealDebrid)'},
    'lucypm': {
        'name'     : 'lucy PM (API Key)',
        'plugin'   : 'plugin.video.lucy',
        'saved'    : 'lucypm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'lucy_pm'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.lucy', 'settings.xml'),
    ...
    'lucypm-oauth': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.lucy', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'lucy_pmoauth'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.lucy', 'settings.xml'),
