...
def dispatch(params):
    ...
    overwrite_cache = params.get("chinook_reload") == "true"
    ...
    g.log("chinook, Running Path - {}".format(g.REQUEST_PARAMS))
    ...
    if action == "genericEndpoint":
        ...
        try:
            ...
            chinook_player = player.chinookPlayer()
            chinook_player.play_source(
