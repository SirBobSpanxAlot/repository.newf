...
class chinookStubs:
    ...
    def create_stubs():
        ...
        return {
            "xbmc": {
                "getInfoLabel": chinookStubs.xbmc.getInfoLabel,
                "translatePath": chinookStubs.xbmc.translatePath,
                "log": chinookStubs.xbmc.log,
                "getSupportedMedia": chinookStubs.xbmc.getSupportedMedia,
                "getLanguage": chinookStubs.xbmc.getLanguage,
                "getLocalizedString": chinookStubs.xbmc.getLocalizedString,
                "getCondVisibility": chinookStubs.xbmc.getCondVisibility,
                "executebuiltin": chinookStubs.xbmc.executebuiltin,
                "PlayList": chinookStubs.xbmc.PlayList,
                "Monitor": chinookStubs.xbmc.Monitor,
                "validatePath": lambda t: t,
                "sleep": lambda t: time.sleep(t / 1000),
                "executeJSONRPC": chinookStubs.xbmc.executeJSONRPC,
            },
            "xbmcaddon": {"Addon": chinookStubs.xbmcaddon.Addon},
            "xbmcgui": {
                "ListItem": chinookStubs.xbmcgui.ListItem,
                "Window": chinookStubs.xbmcgui.Window,
                "Dialog": chinookStubs.xbmcgui.Dialog,
                "DialogBusy": chinookStubs.xbmcgui.DialogBusy,
                "DialogProgress": chinookStubs.xbmcgui.DialogProgress,
                "DialogProgressBG": chinookStubs.xbmcgui.DialogProgressBG,
            },
            "xbmcplugin": {
                "addDirectoryItem": chinookStubs.xbmcplugin.addDirectoryItem,
                "addDirectoryItems": chinookStubs.xbmcplugin.addDirectoryItems,
                "endOfDirectory": chinookStubs.xbmcplugin.endOfDirectory,
                "addSortMethod": chinookStubs.xbmcplugin.addSortMethod,
                "setContent": chinookStubs.xbmcplugin.setContent,
            },
            "xbmcvfs": {
                "File": chinookStubs.File,
        ...
        def translatePath(path):
            ...
            if name == "xbmc":
                ...
                if not MOCK.RUN_AGAINST_INSTALLATION and all(
                        x in parts for x in ["addons", "plugin.video.chinook"]
                ):
    ...
    class xbmcaddon:
        class Addon(xbmcaddon.Addon):
            ...
            def _load_addon_config(self):
                ...
                try:
                    filepath = os.path.join(MOCK.chinook_ROOT, "addon.xml")
...
class MonkeyPatchKodiStub:
    ...
    def __init__(self):
        self._dict = chinookStubs.create_stubs()
...
class MockKodi:
    ...
    def __init__(self):
        ...
        self.chinook_ROOT = self.PROFILE_ROOT
        ...
        self.INTERACTIVE_MODE = (
                os.environ.get("chinook_INTERACTIVE_MODE", False) == "True"
        )
        self.RUN_AGAINST_INSTALLATION = (
                os.environ.get("chinook_RUN_AGAINST_INSTALLATION", False) == "True"
        )
        if self.RUN_AGAINST_INSTALLATION and os.path.exists(
            ...
            self.chinook_ROOT = os.path.join(
                self.PROFILE_ROOT, "addons", "plugin.video.chinook"
            )
