...
from resources.lib.modules.coho_version import do_version_change
from resources.lib.modules.cohoMonitor import cohoMonitor
...
try:
    xbmc.executebuiltin(
        'RunPlugin("plugin://plugin.video.coho/?action=longLifeServiceManager")'
    )
