...
class cohoStubs:
    ...
    def create_stubs():
        ...
        return {
            "xbmc": {
                "getInfoLabel": cohoStubs.xbmc.getInfoLabel,
                "translatePath": cohoStubs.xbmc.translatePath,
                "log": cohoStubs.xbmc.log,
                "getSupportedMedia": cohoStubs.xbmc.getSupportedMedia,
                "getLanguage": cohoStubs.xbmc.getLanguage,
                "getLocalizedString": cohoStubs.xbmc.getLocalizedString,
                "getCondVisibility": cohoStubs.xbmc.getCondVisibility,
                "executebuiltin": cohoStubs.xbmc.executebuiltin,
                "PlayList": cohoStubs.xbmc.PlayList,
                "Monitor": cohoStubs.xbmc.Monitor,
                "validatePath": lambda t: t,
                "sleep": lambda t: time.sleep(t / 1000),
                "executeJSONRPC": cohoStubs.xbmc.executeJSONRPC,
            },
            "xbmcaddon": {"Addon": cohoStubs.xbmcaddon.Addon},
            "xbmcgui": {
                "ListItem": cohoStubs.xbmcgui.ListItem,
                "Window": cohoStubs.xbmcgui.Window,
                "Dialog": cohoStubs.xbmcgui.Dialog,
                "DialogBusy": cohoStubs.xbmcgui.DialogBusy,
                "DialogProgress": cohoStubs.xbmcgui.DialogProgress,
                "DialogProgressBG": cohoStubs.xbmcgui.DialogProgressBG,
            },
            "xbmcplugin": {
                "addDirectoryItem": cohoStubs.xbmcplugin.addDirectoryItem,
                "addDirectoryItems": cohoStubs.xbmcplugin.addDirectoryItems,
                "endOfDirectory": cohoStubs.xbmcplugin.endOfDirectory,
                "addSortMethod": cohoStubs.xbmcplugin.addSortMethod,
                "setContent": cohoStubs.xbmcplugin.setContent,
            },
            "xbmcvfs": {
                "File": cohoStubs.File,
        ...
        def translatePath(path):
            ...
            if name == "xbmc":
                ...
                if not MOCK.RUN_AGAINST_INSTALLATION and all(
                        x in parts for x in ["addons", "plugin.video.coho"]
                ):
    ...
    class xbmcaddon:
        class Addon(xbmcaddon.Addon):
            ...
            def _load_addon_config(self):
                ...
                try:
                    filepath = os.path.join(MOCK.coho_ROOT, "addon.xml")
...
class MonkeyPatchKodiStub:
    ...
    def __init__(self):
        self._dict = cohoStubs.create_stubs()
...
class MockKodi:
    ...
    def __init__(self):
        ...
        self.coho_ROOT = self.PROFILE_ROOT
        ...
        self.INTERACTIVE_MODE = (
                os.environ.get("coho_INTERACTIVE_MODE", False) == "True"
        )
        self.RUN_AGAINST_INSTALLATION = (
                os.environ.get("coho_RUN_AGAINST_INSTALLATION", False) == "True"
        )
        if self.RUN_AGAINST_INSTALLATION and os.path.exists(
            ...
            self.coho_ROOT = os.path.join(
                self.PROFILE_ROOT, "addons", "plugin.video.coho"
            )
