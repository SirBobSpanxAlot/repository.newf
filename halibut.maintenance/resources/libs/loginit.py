...
ORDER = ['easynews-fen',
         ...
         'fanart-scrubs', 'fanart-halibut', 'fanart-thecrew', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         ...
         'tmdb-scrubs', 'tmdb-halibut', 'tmdb-thecrew', 'tmdb-tmdbhelper',
         'tmdb-venom',
         'trakt-openmeta', 'trakt-halibut',
         'tvdb-metahandler', 'tvdb-openmeta', 'tvdb-premiumizer',
         'tvdb-realizer', 'tvdb-halibut',
...
LOGINID = {
    ...
    'tmdb-halibut': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'halibut_tmdb'),
    ...
    'trakt-halibut': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'halibut_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.halibut', 'settings.xml'),
    ...
    'tvdb-halibut': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'halibut_tvdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.halibut', 'settings.xml'),
        'default'  : 'tvdb.apikey',
        'data'     : ['tvdb.apikey', 'tvdb.jw', 'tvdb.expiry'],
        'activate' : ''},
    'fanart-halibut': {
        'name'     : 'Fanart.tv - halibut',
        'plugin'   : 'plugin.video.halibut',
        'saved'    : 'fanart-halibut',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.halibut', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'halibut_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.halibut', 'settings.xml'),
