...
ORDER = ['exodusredux', 'fen', 'gaia', 'numbers', 'openmeta', 'premiumizer',
         'realizer', 'scrubs', 'halibut', 'shadow', 'thecrew', 'trakt', 'venom']
...
TRAKTID = {
    ...
    'halibut': {
        ...
        'file'     : os.path.join(CONFIG.TRAKTFOLD, 'halibut_trakt'),
        ...
        'activate' : 'RunPlugin(plugin://plugin.video.halibut/?action=authTrakt)'},
    'trakt': {
        'name'     : 'Trakt',
        'plugin'   : 'script.trakt',
        'saved'    : 'trakt',
