...
ORDER = ['fenad', 'fenpm', 'fenrd',
         ...
         'pmzer',
         'chinookad', 'chinookpm', 'chinookpm-oauth', 'chinookrd', 
...
DEBRIDID = {
    ...
    'chinookad': {
        'name'     : 'chinook AD',
        'plugin'   : 'plugin.video.chinook',
        'saved'    : 'chinookad',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'chinook_ad'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.chinook', 'settings.xml'),
        'default'  : 'alldebrid.username',
        'data'     : ['alldebrid.enabled', 'alldebrid.username', 'alldebrid.token'],
        'activate' : 'RunPlugin(plugin.video.chinook/?action=openSettings)'},
    'chinookrd': {
        'name'     : 'chinook RD',
        'plugin'   : 'plugin.video.chinook',
        'saved'    : 'chinookrd',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'chinook_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.chinook', 'settings.xml'),
        'default'  : 'rd.username',
        'data'     : [ 'rd.auth', 'rd.client_id', 'rd.expiry', 'rd.refresh', 'rd.secret', 'rd.username', 'realdebrid.enabled'],
        'activate' : 'RunPlugin(plugin://plugin.video.chinook/?action=authRealDebrid)'},
    'chinookpm': {
        'name'     : 'chinook PM (API Key)',
        'plugin'   : 'plugin.video.chinook',
        'saved'    : 'chinookpm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'chinook_pm'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.chinook', 'settings.xml'),
        'default'  : 'premiumize.pin',
        'data'     : ['premiumize.enabled', 'premiumize.pin'],
        'activate' : 'RunPlugin(plugin.video.chinook/?action=openSettings)'},
    'chinookpm-oauth': {
        'name'     : 'chinook PM (OAuth)',
        'plugin'   : 'plugin.video.chinook',
        'saved'    : 'chinookpm-oauth',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.chinook', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'chinook_pmoauth'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.chinook', 'settings.xml'),
