...
ORDER = ['easynews-fen',
         ...
         'fanart-scrubs', 'fanart-coho', 'fanart-thecrew', 'fanart-tmdbhelper',
         'fanart-venom',
         'furk-fen',
         ...
         'tmdb-scrubs', 'tmdb-coho', 'tmdb-thecrew', 'tmdb-tmdbhelper',
         'tmdb-venom',
         'trakt-openmeta', 'trakt-coho',
         'tvdb-metahandler', 'tvdb-openmeta', 'tvdb-premiumizer',
         'tvdb-realizer', 'tvdb-coho',
...
LOGINID = {
    ...
    'tmdb-coho': {
        'name'     : 'TMDb - coho',
        'plugin'   : 'plugin.video.coho',
        'saved'    : 'tmdb-coho',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'coho_tmdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.coho', 'settings.xml'),
        'default'  : 'tmdb.apikey',
        'data'     : ['tmdb.apikey'],
        'activate' : ''},
    'trakt-coho': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'coho_trakt'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.coho', 'settings.xml'),
    ...
    'tvdb-coho': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'coho_tvdb'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.coho', 'settings.xml'),
        'default'  : 'tvdb.apikey',
    ...
    'fanart-coho': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'ico-fox-gold-final.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'fanart-fox-gold-final.png'),
        'file'     : os.path.join(CONFIG.LOGINFOLD, 'coho_fanart'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.coho', 'settings.xml'),
