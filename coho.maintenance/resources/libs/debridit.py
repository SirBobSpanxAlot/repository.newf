...
ORDER = ['fenad', 'fenpm', 'fenrd',
         ...
         'pmzer',
         'cohoad', 'cohopm', 'cohopm-oauth', 'cohord', 
...
DEBRIDID = {
    ...
    'cohoad': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'coho_ad'),
        ...
        'activate' : 'RunPlugin(plugin.video.coho/?action=openSettings)'},
    'cohord': {
        'name'     : 'coho RD',
        'plugin'   : 'plugin.video.coho',
        'saved'    : 'cohord',
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'coho_rd'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.coho', 'settings.xml'),
        'default'  : 'rd.username',
        'data'     : [ 'rd.auth', 'rd.client_id', 'rd.expiry', 'rd.refresh', 'rd.secret', 'rd.username', 'realdebrid.enabled'],
        'activate' : 'RunPlugin(plugin://plugin.video.coho/?action=authRealDebrid)'},
    'cohopm': {
        'name'     : 'coho PM (API Key)',
        'plugin'   : 'plugin.video.coho',
        'saved'    : 'cohopm',
        'path'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho'),
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'coho_pm'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.coho', 'settings.xml'),
    ...
    'cohopm-oauth': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'temp-icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.coho', 'temp-fanart.png'),
        'file'     : os.path.join(CONFIG.DEBRIDFOLD, 'coho_pmoauth'),
        'settings' : os.path.join(CONFIG.ADDON_DATA, 'plugin.video.coho', 'settings.xml'),
