...
class sockeyeStubs:
    ...
    def create_stubs():
        ...
        return {
            "xbmc": {
                "getInfoLabel": sockeyeStubs.xbmc.getInfoLabel,
                "translatePath": sockeyeStubs.xbmc.translatePath,
                "log": sockeyeStubs.xbmc.log,
                "getSupportedMedia": sockeyeStubs.xbmc.getSupportedMedia,
                "getLanguage": sockeyeStubs.xbmc.getLanguage,
                "getLocalizedString": sockeyeStubs.xbmc.getLocalizedString,
                "getCondVisibility": sockeyeStubs.xbmc.getCondVisibility,
                "executebuiltin": sockeyeStubs.xbmc.executebuiltin,
                "PlayList": sockeyeStubs.xbmc.PlayList,
                "Monitor": sockeyeStubs.xbmc.Monitor,
                "validatePath": lambda t: t,
                "sleep": lambda t: time.sleep(t / 1000),
                "executeJSONRPC": sockeyeStubs.xbmc.executeJSONRPC,
            },
            "xbmcaddon": {"Addon": sockeyeStubs.xbmcaddon.Addon},
            "xbmcgui": {
                "ListItem": sockeyeStubs.xbmcgui.ListItem,
                "Window": sockeyeStubs.xbmcgui.Window,
                "Dialog": sockeyeStubs.xbmcgui.Dialog,
                "DialogBusy": sockeyeStubs.xbmcgui.DialogBusy,
                "DialogProgress": sockeyeStubs.xbmcgui.DialogProgress,
                "DialogProgressBG": sockeyeStubs.xbmcgui.DialogProgressBG,
            },
            "xbmcplugin": {
                "addDirectoryItem": sockeyeStubs.xbmcplugin.addDirectoryItem,
                "addDirectoryItems": sockeyeStubs.xbmcplugin.addDirectoryItems,
                "endOfDirectory": sockeyeStubs.xbmcplugin.endOfDirectory,
                "addSortMethod": sockeyeStubs.xbmcplugin.addSortMethod,
                "setContent": sockeyeStubs.xbmcplugin.setContent,
            },
            "xbmcvfs": {
                "File": sockeyeStubs.File,
        ...
        def translatePath(path):
            ...
            if name == "xbmc":
                ...
                if not MOCK.RUN_AGAINST_INSTALLATION and all(
                        x in parts for x in ["addons", "plugin.video.sockeye"]
                ):
    ...
    class xbmcaddon:
        class Addon(xbmcaddon.Addon):
            ...
            def _load_addon_config(self):
                ...
                try:
                    filepath = os.path.join(MOCK.sockeye_ROOT, "addon.xml")
...
class MonkeyPatchKodiStub:
    ...
    def __init__(self):
        self._dict = sockeyeStubs.create_stubs()
...
class MockKodi:
    ...
    def __init__(self):
        ...
        self.sockeye_ROOT = self.PROFILE_ROOT
        ...
        self.INTERACTIVE_MODE = (
                os.environ.get("sockeye_INTERACTIVE_MODE", False) == "True"
        )
        self.RUN_AGAINST_INSTALLATION = (
                os.environ.get("sockeye_RUN_AGAINST_INSTALLATION", False) == "True"
        )
        if self.RUN_AGAINST_INSTALLATION and os.path.exists(
            ...
            self.sockeye_ROOT = os.path.join(
                self.PROFILE_ROOT, "addons", "plugin.video.sockeye"
            )
